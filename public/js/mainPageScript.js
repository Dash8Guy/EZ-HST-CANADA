...
myDOMs.main_page.SelectPeriod.addEventListener('change', function (e) {
   ...
   switch (myDOMs.main_page.SelectPeriod.value) {
      case 'Full Year':
         myDOMs.main_page.StartDate.value = '2019-01-01';
         myDOMs.main_page.EndDate.value = '2019-12-31';
         break;
      case '1st ¼':
         myDOMs.main_page.StartDate.value = '2019-01-01';
         myDOMs.main_page.EndDate.value = '2019-03-31';
         break;
      case '2nd ¼':
         myDOMs.main_page.StartDate.value = '2019-04-01';
         myDOMs.main_page.EndDate.value = '2019-06-30';
         break;
      case '3rd ¼':
         myDOMs.main_page.StartDate.value = '2019-07-01';
         myDOMs.main_page.EndDate.value = '2019-09-30';
         break;
      case '4th ¼':
         myDOMs.main_page.StartDate.value = '2019-10-01';
         myDOMs.main_page.EndDate.value = '2019-12-31';
         break;
      case '1st ½':
         myDOMs.main_page.StartDate.value = '2019-01-01';
      ...
      case 'January':
         myDOMs.main_page.StartDate.value = '2019-01-01';
         myDOMs.main_page.EndDate.value = '2019-01-31';
         break;
      case 'February':
         myDOMs.main_page.StartDate.value = '2019-02-01';
         myDOMs.main_page.EndDate.value = '2019-02-28';
         break;
      case 'March':
         myDOMs.main_page.StartDate.value = '2019-03-01';
         myDOMs.main_page.EndDate.value = '2019-03-31';
         break;
      case 'April':
         myDOMs.main_page.StartDate.value = '2019-04-01';
         myDOMs.main_page.EndDate.value = '2019-04-30';
         break;
      case 'May':
         myDOMs.main_page.StartDate.value = '2019-05-01';
         myDOMs.main_page.EndDate.value = '2019-05-31';
         break;
      case 'June':
         myDOMs.main_page.StartDate.value = '2019-06-01';
         myDOMs.main_page.EndDate.value = '2019-06-30';
         break;
      case 'July':
         myDOMs.main_page.StartDate.value = '2019-07-01';
         myDOMs.main_page.EndDate.value = '2019-07-31';
         break;
      case 'August':
         myDOMs.main_page.StartDate.value = '2019-08-01';
         myDOMs.main_page.EndDate.value = '2019-08-31';
         break;
      case 'September':
         myDOMs.main_page.StartDate.value = '2019-09-01';
         myDOMs.main_page.EndDate.value = '2019-09-30';
         break;
      case 'October':
         myDOMs.main_page.StartDate.value = '2019-10-01';
         myDOMs.main_page.EndDate.value = '2019-10-31';
         break;
      case 'November':
         myDOMs.main_page.StartDate.value = '2019-11-01';
         myDOMs.main_page.EndDate.value = '2019-11-30';
         break;
      case 'December':
         myDOMs.main_page.StartDate.value = '2019-12-01';
         myDOMs.main_page.EndDate.value = '2019-12-31';
   }
   startDate = new Date(myDOMs.main_page.StartDate.value);
   endDate = new Date(myDOMs.main_page.EndDate.value);
